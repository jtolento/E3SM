...
10          continue
  ...
  subroutine lnd_export( bounds, lnd2atm_vars, lnd2glc_vars, l2x)
    ...
    do g = bounds%begg,bounds%endg
       ...
       l2x(index_l2x_Sl_snowfrac,i)    =  lnd2atm_vars%snowfrac_grc(g) 
       ...
       l2x(index_l2x_Sl_alb_nir_a_dir,i)    = lnd2atm_vars%spc_albd_grc(g,2)
       l2x(index_l2x_Sl_alb_nir_b_dir,i)    = lnd2atm_vars%spc_albd_grc(g,3)
