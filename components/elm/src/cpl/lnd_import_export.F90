...
10          continue
  ...
  subroutine lnd_export( bounds, lnd2atm_vars, lnd2glc_vars, l2x)
    ...
    do g = bounds%begg,bounds%endg
       ...
       l2x(index_l2x_Sl_alb_nir_a_dir,i)    =  lnd2atm_vars%albi_grc(g,2)!lnd2atm_vars%spc_albd_grc(g,2)
       l2x(index_l2x_Sl_alb_nir_b_dir,i)    =  lnd2atm_vars%albi_grc(g,2)!lnd2atm_vars%spc_albd_grc(g,3)
       l2x(index_l2x_Sl_alb_nir_c_dir,i)    =  lnd2atm_vars%albi_grc(g,2)!lnd2atm_vars%spc_albd_grc(g,4)
       l2x(index_l2x_Sl_alb_nir_d_dir,i)    =  lnd2atm_vars%albi_grc(g,2)!lnd2atm_vars%spc_albd_grc(g,5)
       l2x(index_l2x_Sl_alb_nir_e_dir,i)    =  lnd2atm_vars%albi_grc(g,2)!lnd2atm_vars%spc_albd_grc(g,6)
       l2x(index_l2x_Sl_alb_nir_f_dir,i)    =  lnd2atm_vars%albi_grc(g,2)!lnd2atm_vars%spc_albd_grc(g,7)
       l2x(index_l2x_Sl_alb_nir_g_dir,i)    =  lnd2atm_vars%albi_grc(g,2)!lnd2atm_vars%spc_albd_grc(g,8)
       l2x(index_l2x_Sl_alb_nir_a_dif,i)    =  lnd2atm_vars%albi_grc(g,2)!lnd2atm_vars%spc_albi_grc(g,2)
       l2x(index_l2x_Sl_alb_nir_b_dif,i)    =  lnd2atm_vars%albi_grc(g,2)!lnd2atm_vars%spc_albi_grc(g,3)
       l2x(index_l2x_Sl_alb_nir_c_dif,i)    =  lnd2atm_vars%albi_grc(g,2)!lnd2atm_vars%spc_albi_grc(g,4)
       l2x(index_l2x_Sl_alb_nir_d_dif,i)    =  lnd2atm_vars%albi_grc(g,2)!lnd2atm_vars%spc_albi_grc(g,5)
       l2x(index_l2x_Sl_alb_nir_e_dif,i)    =  lnd2atm_vars%albi_grc(g,2)!lnd2atm_vars%spc_albi_grc(g,6)
       l2x(index_l2x_Sl_alb_nir_f_dif,i)    =  lnd2atm_vars%albi_grc(g,2)!lnd2atm_vars%spc_albi_grc(g,7)
       l2x(index_l2x_Sl_alb_nir_g_dif,i)    =  lnd2atm_vars%albi_grc(g,2)!lnd2atm_vars%spc_albi_grc(g,8)
