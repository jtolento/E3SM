...
#include "shr_assert.h"
  ...
  real(r8) :: ss_alb_snw_drc_8bnd     (idx_Mie_snw_mx,8);
  real(r8) :: asm_prm_snw_drc_8bnd    (idx_Mie_snw_mx,8);
  real(r8) :: ext_cff_mss_snw_drc_8bnd(idx_Mie_snw_mx,8);
  ...
  real(r8) :: ss_alb_snw_dfs_8bnd     (idx_Mie_snw_mx,8);
  real(r8) :: asm_prm_snw_dfs_8bnd    (idx_Mie_snw_mx,8);
  real(r8) :: ext_cff_mss_snw_dfs_8bnd(idx_Mie_snw_mx,8);
  ...
  real(r8) :: ss_alb_bc1_8bnd     (8,idx_bc_nclrds_max);
  real(r8) :: asm_prm_bc1_8bnd     (8,idx_bc_nclrds_max);
  real(r8) :: ext_cff_mss_bc1_8bnd (8,idx_bc_nclrds_max);
  ...
  real(r8) :: ss_alb_bc2_8bnd     (8,idx_bc_nclrds_max);
  real(r8) :: asm_prm_bc2_8bnd    (8,idx_bc_nclrds_max);
  real(r8) :: ext_cff_mss_bc2_8bnd(8,idx_bc_nclrds_max);
  ...
  real(r8) :: ss_alb_bc1_8bnd     (8);
  real(r8) :: asm_prm_bc1_8bnd    (8);
  real(r8) :: ext_cff_mss_bc1_8bnd(8);
  !$acc declare create(ss_alb_bc1     )
  !$acc declare create(asm_prm_bc1    )
  !$acc declare create(ext_cff_mss_bc1)
  ...
  real(r8) :: ss_alb_bc2_8bnd     (8);
  real(r8) :: asm_prm_bc2_8bnd    (8);
  real(r8) :: ext_cff_mss_bc2_8bnd(8);
  !$acc declare create(ss_alb_bc2     )
  !$acc declare create(asm_prm_bc2    )
  !$acc declare create(ext_cff_mss_bc2)
...
!  real(r8) :: ext_cff_mss_bc2(numrad_snw)
  ...
  real(r8) :: ss_alb_oc1_8bnd     (8);
  real(r8) :: asm_prm_oc1_8bnd     (8);
  real(r8) :: ext_cff_mss_oc1_8bnd (8);
  ...
  real(r8) :: ss_alb_oc2_8bnd     (8);
  real(r8) :: asm_prm_oc2_8bnd    (8);
  real(r8) :: ext_cff_mss_oc2_8bnd(8);
  ...
  real(r8) :: ss_alb_dst1_8bnd     (8);
  real(r8) :: asm_prm_dst1_8bnd     (8);
  real(r8) :: ext_cff_mss_dst1_8bnd (8);
  ...
  real(r8) :: ss_alb_dst2_8bnd      (8);
  real(r8) :: asm_prm_dst2_8bnd     (8);
  real(r8) :: ext_cff_mss_dst2_8bnd (8);
  ...
  real(r8) :: ss_alb_dst3_8bnd      (8);
  real(r8) :: asm_prm_dst3_8bnd     (8);
  real(r8) :: ext_cff_mss_dst3_8bnd (8);
  ...
  real(r8) :: ss_alb_dst4_8bnd      (8);
  real(r8) :: asm_prm_dst4_8bnd     (8);
  real(r8) :: ext_cff_mss_dst4_8bnd (8);
  ...
  real(r8) :: bcenh_8bnd(8,idx_bc_nclrds_max,idx_bcint_icerds_max);
...
!H. Wang
  ...
  !-----------------------------------------------------------------------
     subroutine SnowOptics_init( )
      ...
      use elm_varctl , only : fsnowoptics, snicar_atm_type!, fsnowoptics_8bnd !JPT
      use spmdMod    , only : masterproc
      use ncdio_pio  , only : file_desc_t, ncd_io, ncd_pio_openfile, ncd_pio_closefile
      use ncdio_pio  , only : ncd_pio_openfile, ncd_inqfdims, ncd_pio_closefile, ncd_inqdid, ncd_inqdlen

      type(file_desc_t)  :: ncid                        ! netCDF file id
      type(file_desc_t)  :: ncid_8bnd                   ! netCDF file id  
      character(len=256) :: fsnowoptics_8bnd           ! local filename 
      character(len=256) :: locfn                       ! local filename
      character(len=256) :: locfn_8bnd                  ! local filename  
     ...
     !mgf--
      fsnowoptics_8bnd = '/global/cfs/cdirs/e3sm/inputdata/lnd/clm2/snicardata/snicar_optics_5bnd_mam_c250717.nc'
    ...
    !$acc )
     ...
     !$acc ext_cff_mss_dst4  )
      ...
      ! direct-beam snow Mie parameters:
      call ncd_io('ss_alb_ice_drc', ss_alb_snw_drc_8bnd,            'read', ncid_8bnd, posNOTonfile=.true.)
      call ncd_io( 'asm_prm_ice_drc',asm_prm_snw_drc_8bnd,          'read', ncid_8bnd, posNOTonfile=.true.)
      call ncd_io( 'ext_cff_mss_ice_drc', ext_cff_mss_snw_drc_8bnd, 'read', ncid_8bnd, posNOTonfile=.true.)
      !
      ! diffuse snow Mie parameters
      call ncd_io( 'ss_alb_ice_dfs', ss_alb_snw_dfs_8bnd,           'read', ncid_8bnd, posNOTonfile=.true.)
      call ncd_io( 'asm_prm_ice_dfs', asm_prm_snw_dfs_8bnd,         'read', ncid_8bnd, posNOTonfile=.true.)
      call ncd_io( 'ext_cff_mss_ice_dfs', ext_cff_mss_snw_dfs_8bnd, 'read', ncid_8bnd, posNOTonfile=.true.)
	  
      !!! Direct and diffuse flux under different atmospheric conditions
      ! Direct-beam incident spectral flux: 
      call ncd_io( 'flx_wgt_dir', flx_wgt_dir,           'read', ncid_8bnd, readvar=readvar, posNOTonfile=.true.)
      if ((atm_type_index > 0) .and. (.not. readvar)) call endrun( "ERROR: error in reading in flx_wgt_dir data" )
      ! Diffuse incident spectral flux:
      call ncd_io( 'flx_wgt_dif', flx_wgt_dif,           'read', ncid_8bnd, readvar=readvar, posNOTonfile=.true.)
      if ((atm_type_index > 0) .and. (.not. readvar)) call endrun( "ERROR: error in reading in flx_wgt_dif data" )
     ...
     !
     ! BC species 1 Mie parameters
     call ncd_io( 'ss_alb_bc_mam', ss_alb_bc1_8bnd,           'read', ncid_8bnd, readvar=readvar, posNOTonfile=.true.)
     if (.not. readvar) call endrun()
     call ncd_io( 'asm_prm_bc_mam', asm_prm_bc1_8bnd,         'read', ncid_8bnd, readvar=readvar, posNOTonfile=.true.)
     if (.not. readvar) call endrun()
     call ncd_io( 'ext_cff_mss_bc_mam', ext_cff_mss_bc1_8bnd, 'read', ncid_8bnd, readvar=readvar, posNOTonfile=.true.)
     if (.not. readvar) call endrun()
     !
     ! BC species 2 Mie parameters (identical, before enhancement factors applied)
     call ncd_io( 'ss_alb_bc_mam', ss_alb_bc2_8bnd,           'read', ncid_8bnd, readvar=readvar, posNOTonfile=.true.)
     if (.not. readvar) call endrun()
     call ncd_io( 'asm_prm_bc_mam', asm_prm_bc2_8bnd,         'read', ncid_8bnd, readvar=readvar, posNOTonfile=.true.)
     if (.not. readvar) call endrun()
     call ncd_io( 'ext_cff_mss_bc_mam', ext_cff_mss_bc2_8bnd, 'read', ncid_8bnd, readvar=readvar, posNOTonfile=.true.)
     if (.not. readvar) call endrun()
     !
     ! size-dependent BC absorption enhancement factors for within-ice BC
     call ncd_io( 'bcint_enh_mam', bcenh_8bnd, 'read', ncid_8bnd, readvar=readvar, posNOTonfile=.true.)
     if (.not. readvar) call endrun()
     !$acc update device(bcenh)
     !
#else
     ! bulk aerosol treatment
      ! BC species 1 Mie parameters
      call ncd_io( 'ss_alb_bcphil', ss_alb_bc1_8bnd,           'read', ncid_8bnd, posNOTonfile=.true.)
      call ncd_io( 'asm_prm_bcphil', asm_prm_bc1_8bnd,         'read', ncid_8bnd, posNOTonfile=.true.)
      call ncd_io( 'ext_cff_mss_bcphil', ext_cff_mss_bc1_8bnd, 'read', ncid_8bnd, posNOTonfile=.true.)
      !
      ! BC species 2 Mie parameters
      call ncd_io( 'ss_alb_bcphob', ss_alb_bc2_8bnd,           'read', ncid_8bnd, posNOTonfile=.true.)
      call ncd_io( 'asm_prm_bcphob', asm_prm_bc2_8bnd,         'read', ncid_8bnd, posNOTonfile=.true.)
      call ncd_io( 'ext_cff_mss_bcphob', ext_cff_mss_bc2_8bnd, 'read', ncid_8bnd, posNOTonfile=.true.)
      !
     !mgf--
#endif
    !$acc update device( &
    ...
    !$acc )
      !
      ! OC species 1 Mie parameters
      call ncd_io( 'ss_alb_ocphil',      ss_alb_oc1_8bnd,      'read', ncid_8bnd, posNOTonfile=.true.)
      call ncd_io( 'asm_prm_ocphil',     asm_prm_oc1_8bnd,     'read', ncid_8bnd, posNOTonfile=.true.)
      call ncd_io( 'ext_cff_mss_ocphil', ext_cff_mss_oc1_8bnd, 'read', ncid_8bnd, posNOTonfile=.true.)
      !
      ! OC species 2 Mie parameters
      call ncd_io( 'ss_alb_ocphob', ss_alb_oc2_8bnd,           'read', ncid_8bnd, posNOTonfile=.true.)
      call ncd_io( 'asm_prm_ocphob', asm_prm_oc2_8bnd,         'read', ncid_8bnd, posNOTonfile=.true.)
      call ncd_io( 'ext_cff_mss_ocphob', ext_cff_mss_oc2_8bnd, 'read', ncid_8bnd, posNOTonfile=.true.)
      !
      ! dust species 1 Mie parameters
      call ncd_io( 'ss_alb_dust01', ss_alb_dst1_8bnd,           'read', ncid_8bnd, posNOTonfile=.true.)
      call ncd_io( 'asm_prm_dust01', asm_prm_dst1_8bnd,         'read', ncid_8bnd, posNOTonfile=.true.)
      call ncd_io( 'ext_cff_mss_dust01', ext_cff_mss_dst1_8bnd, 'read', ncid_8bnd, posNOTonfile=.true.)
      !
      ! dust species 2 Mie parameters
      call ncd_io( 'ss_alb_dust02', ss_alb_dst2_8bnd,           'read', ncid_8bnd, posNOTonfile=.true.)
      call ncd_io( 'asm_prm_dust02', asm_prm_dst2_8bnd,         'read', ncid_8bnd, posNOTonfile=.true.)
      call ncd_io( 'ext_cff_mss_dust02', ext_cff_mss_dst2_8bnd, 'read', ncid_8bnd, posNOTonfile=.true.)
      !
      ! dust species 3 Mie parameters
      call ncd_io( 'ss_alb_dust03', ss_alb_dst3_8bnd,           'read', ncid_8bnd, posNOTonfile=.true.)
      call ncd_io( 'asm_prm_dust03', asm_prm_dst3_8bnd,         'read', ncid_8bnd, posNOTonfile=.true.)
      call ncd_io( 'ext_cff_mss_dust03', ext_cff_mss_dst3_8bnd, 'read', ncid_8bnd, posNOTonfile=.true.)
      !
      ! dust species 4 Mie parameters
      call ncd_io( 'ss_alb_dust04', ss_alb_dst4_8bnd,           'read', ncid_8bnd, posNOTonfile=.true.)
      call ncd_io( 'asm_prm_dust04', asm_prm_dst4_8bnd,         'read', ncid_8bnd, posNOTonfile=.true.)
      call ncd_io( 'ext_cff_mss_dust04', ext_cff_mss_dst4_8bnd, 'read', ncid_8bnd, posNOTonfile=.true.)
      !
      !
     !$acc update device( &
     !$acc ss_alb_oc1       ,&
     ...
     !$acc ext_cff_mss_dst4  )
      ...
      call ncd_pio_closefile(ncid_8bnd)
      if (masterproc) then
        !
         write(iulog,*) 'Successfully read snow optical properties'
         ! print some diagnostics:
   ...
   subroutine SNICAR_AD_8bnd (flg_snw_ice, bounds, num_nourbanc, filter_nourbanc,  &
                         coszen, flg_slr_in, h2osno_liq, h2osno_ice, snw_rds,   &
     ...
     real(r8)          , intent(in)  :: mss_cnc_aer_in ( bounds%begc: , -nlevsno+1: , 1: ) ! mass concentration of all aerosol species (col,lyr,aer) [kg/kg]
     real(r8)          , intent(in)  :: albsfc         ( bounds%begc: , 1: )               ! albedo of surface underlying snow (col,bnd) [frc]
     real(r8)          , intent(in)  :: nir_bands_flx  ( bounds%begc: , 1: )  
     real(r8)          , intent(out) :: albout         ( bounds%begc: , 1: )               ! snow albedo, averaged into 2 bands (=0 if no sun or no snow) (col,bnd) [frc]
     real(r8)          , intent(out) :: spc_albout     ( bounds%begc: , 1: )  
     real(r8)          , intent(out) :: flx_abs        ( bounds%begc: , -nlevsno+1: , 1: ) ! absorbed flux in each layer per unit flux incident (col, lyr, bnd)
     !
     ! !LOCAL VARIABLES:
     !
     ...
     ! Local variables representing single-column values of arrays:
     integer,  parameter :: numrad_snw  =   8
  integer,  parameter :: nir_bnd_bgn =   2   
  integer,  parameter :: nir_bnd_end =   8              
     integer :: snl_lcl                            ! negative number of snow layers [nbr]
     integer :: snw_rds_lcl(-nlevsno+1:0)          ! snow effective radius [m^-6]
     real(r8):: flx_slrd_lcl(1:numrad_snw)         ! direct beam incident irradiance [W/m2] (set to 1)
     real(r8):: flx_slri_lcl(1:numrad_snw)         ! diffuse incident irradiance [W/m2] (set to 1)
                ...
                mu_not = max(coszen(c_idx), cp01)
                   ...
                   if (flg_slr_in == 1) then
                      do i=snl_top,snl_btm,1
                         rds_idx = snw_rds_lcl(i) - snw_rds_min_tbl + 1
                         ! snow optical properties (direct radiation)
                         ss_alb_snw_lcl(i)      = ss_alb_snw_drc_8bnd(rds_idx,bnd_idx)
                         asm_prm_snw_lcl(i)     = asm_prm_snw_drc_8bnd(rds_idx,bnd_idx)
                         ext_cff_mss_snw_lcl(i) = ext_cff_mss_snw_drc_8bnd(rds_idx,bnd_idx)
                      enddo
                   elseif (flg_slr_in == 2) then
                      do i=snl_top,snl_btm,1
                         rds_idx = snw_rds_lcl(i) - snw_rds_min_tbl + 1
                         ! snow optical properties (diffuse radiation)
                         ss_alb_snw_lcl(i)      = ss_alb_snw_dfs_8bnd(rds_idx,bnd_idx)
                         asm_prm_snw_lcl(i)     = asm_prm_snw_dfs_8bnd(rds_idx,bnd_idx)
                         ext_cff_mss_snw_lcl(i) = ext_cff_mss_snw_dfs_8bnd(rds_idx,bnd_idx)
                      enddo
                   endif
   ...
   !H. Wang
                   ! aerosol species 3 optical properties
                   ss_alb_aer_lcl(3)        = ss_alb_oc1_8bnd(bnd_idx)
                   asm_prm_aer_lcl(3)       = asm_prm_oc1_8bnd(bnd_idx)
                   ext_cff_mss_aer_lcl(3)   = ext_cff_mss_oc1_8bnd(bnd_idx)

                   ! aerosol species 4 optical properties
                   ss_alb_aer_lcl(4)        = ss_alb_oc2_8bnd(bnd_idx)
                   asm_prm_aer_lcl(4)       = asm_prm_oc2_8bnd(bnd_idx)
                   ext_cff_mss_aer_lcl(4)   = ext_cff_mss_oc2_8bnd(bnd_idx)

                   ! aerosol species 5 optical properties
                   ss_alb_aer_lcl(5)        = ss_alb_dst1_8bnd(bnd_idx)
                   asm_prm_aer_lcl(5)       = asm_prm_dst1_8bnd(bnd_idx)
                   ext_cff_mss_aer_lcl(5)   = ext_cff_mss_dst1_8bnd(bnd_idx)

                   ! aerosol species 6 optical properties
                   ss_alb_aer_lcl(6)        = ss_alb_dst2_8bnd(bnd_idx)
                   asm_prm_aer_lcl(6)       = asm_prm_dst2_8bnd(bnd_idx)
                   ext_cff_mss_aer_lcl(6)   = ext_cff_mss_dst2_8bnd(bnd_idx)

                   ! aerosol species 7 optical properties
                   ss_alb_aer_lcl(7)        = ss_alb_dst3_8bnd(bnd_idx)
                   asm_prm_aer_lcl(7)       = asm_prm_dst3_8bnd(bnd_idx)
                   ext_cff_mss_aer_lcl(7)   = ext_cff_mss_dst3_8bnd(bnd_idx)

                   ! aerosol species 8 optical properties
                   ss_alb_aer_lcl(8)        = ss_alb_dst4_8bnd(bnd_idx)
                   asm_prm_aer_lcl(8)       = asm_prm_dst4_8bnd(bnd_idx)
                   ext_cff_mss_aer_lcl(8)   = ext_cff_mss_dst4_8bnd(bnd_idx)
                   ...
                   do i=snl_top,snl_btm,1
                    ...
                    ! retrieve absorption enhancement factor for within-ice BC
                    enh_fct = bcenh_8bnd(bnd_idx,idx_bcint_nclrds,idx_bcint_icerds)

                    ! get BC optical properties (moved from above)
                    ! aerosol species 1 optical properties (within-ice BC)
                    ss_alb_aer_lcl(1)        = ss_alb_bc1_8bnd(bnd_idx,idx_bcint_nclrds)
                    asm_prm_aer_lcl(1)       = asm_prm_bc1_8bnd(bnd_idx,idx_bcint_nclrds)
                    ext_cff_mss_aer_lcl(1)   = ext_cff_mss_bc1_8bnd(bnd_idx,idx_bcint_nclrds)*enh_fct

                    ! aerosol species 2 optical properties (external BC)
                    ss_alb_aer_lcl(2)        = ss_alb_bc2_8bnd(bnd_idx,idx_bcext_nclrds)
                    asm_prm_aer_lcl(2)       = asm_prm_bc2_8bnd(bnd_idx,idx_bcext_nclrds)
                    ext_cff_mss_aer_lcl(2)   = ext_cff_mss_bc2_8bnd(bnd_idx,idx_bcext_nclrds)

#else
                    ! bulk aerosol treatment (BC optical properties independent
                    ! of BC and ice grain size)
                    ! aerosol species 1 optical properties (within-ice BC)
                    ss_alb_aer_lcl(1)        = ss_alb_bc1_8bnd(bnd_idx)
                    asm_prm_aer_lcl(1)       = asm_prm_bc1_8bnd(bnd_idx)
                    ext_cff_mss_aer_lcl(1)   = ext_cff_mss_bc1_8bnd(bnd_idx)

                    ! aerosol species 2 optical properties
                    ss_alb_aer_lcl(2)        = ss_alb_bc2_8bnd(bnd_idx)
                    asm_prm_aer_lcl(2)       = asm_prm_bc2_8bnd(bnd_idx)
                    ext_cff_mss_aer_lcl(2)   = ext_cff_mss_bc2_8bnd(bnd_idx)
#endif
