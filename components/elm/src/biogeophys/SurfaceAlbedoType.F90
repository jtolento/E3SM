...
contains
  ...
  subroutine InitAllocate(this, bounds)
    ...
    allocate(this%spc_albgrd_col     (begc:endc,numrad_snw))   ; this%spc_albgrd_col     (:,:) =spval 
    allocate(this%spc_albgri_col     (begc:endc,numrad_snw))   ; this%spc_albgri_col     (:,:) =spval 
