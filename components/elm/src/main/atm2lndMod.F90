...
contains
  ...
  subroutine downscale_forcings(bounds,num_do_smb_c,filter_do_smb_c, atm2lnd_vars)
    ...
    associate(&
         ...
         forc_nir_bands_dir_g => atm2lnd_vars%forc_nir_bands_dir_not_downscaled , &                                                           
         forc_nir_bands_dif_g => atm2lnd_vars%forc_nir_bands_dif_not_downscaled , & 
         ...
         forc_nir_bands_dir_c => atm2lnd_vars%forc_nir_bands_dir_downscaled, & 
         forc_nir_bands_dif_c => atm2lnd_vars%forc_nir_bands_dif_downscaled  &  
         )
