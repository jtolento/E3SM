...
! ---------------------------------------------------------------------------
      subroutine spcvrt_sw &
            (lchnk, iplon, nlayers, istart, iend, icpr, idelm, iout, dotau, &
...
! Store ztaug, ztaur, and zsflxzen for use when dotau is false
            ztaugst(iplon,:nlayers,:ngptsw,lchnk) = ztaug(:nlayers,:ngptsw)
            ztaurst(iplon,:nlayers,:ngptsw,lchnk) = ztaur(:nlayers,:ngptsw)
            zsflxzenst(iplon,:ngptsw,lchnk) = zsflxzen(:ngptsw)

         else

! Restore ztaug, ztaur, and zsflxzen from storage when dotau is false
            ztaug(:nlayers,:ngptsw) = ztaugst(iplon,:nlayers,:ngptsw,lchnk)
            ztaur(:nlayers,:ngptsw) = ztaurst(iplon,:nlayers,:ngptsw,lchnk)
            zsflxzen(:ngptsw) = zsflxzenst(iplon,:ngptsw,lchnk)
