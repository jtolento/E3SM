...
subroutine atm_import_moab(Eclock, cam_in, restart_init )
    ...
    do c=begchunk,endchunk
       ...
       do i =1,ncols
          ...
          !JPT
          cam_in(c)%alb_nir_dir(i,1)     =  x2a_am(ig,index_x2a_Sx_alb_nir_a_dir) 
          cam_in(c)%alb_nir_dir(i,2)     =  x2a_am(ig,index_x2a_Sx_alb_nir_b_dir)
          cam_in(c)%alb_nir_dir(i,3)     =  x2a_am(ig,index_x2a_Sx_alb_nir_c_dir)
          cam_in(c)%alb_nir_dir(i,4)     =  x2a_am(ig,index_x2a_Sx_alb_nir_d_dir)
          cam_in(c)%alb_nir_dir(i,5)     =  x2a_am(ig,index_x2a_Sx_alb_nir_e_dir)
          !cam_in(c)%alb_nir_dir(i,6)     =  x2a_am(ig,index_x2a_Sx_alb_nir_f_dir)
          !cam_in(c)%alb_nir_dir(i,7)     =  x2a_am(ig,index_x2a_Sx_alb_nir_g_dir)
          cam_in(c)%alb_nir_dif(i,1)     =  x2a_am(ig,index_x2a_Sx_alb_nir_a_dif)
          cam_in(c)%alb_nir_dif(i,2)     =  x2a_am(ig,index_x2a_Sx_alb_nir_b_dif)
          cam_in(c)%alb_nir_dif(i,3)     =  x2a_am(ig,index_x2a_Sx_alb_nir_c_dif)
          cam_in(c)%alb_nir_dif(i,4)     =  x2a_am(ig,index_x2a_Sx_alb_nir_d_dif)
          ...
          cam_in(c)%snowfrac(i)  =  x2a_am(ig,index_x2a_Sl_snowfrac) !JPT
