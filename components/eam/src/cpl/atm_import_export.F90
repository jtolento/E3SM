  ...
  subroutine atm_import( x2a, cam_in, restart_init )
    ...
    do c=begchunk,endchunk
       ...
       do i =1,ncols                                                               
          ...
          cam_in(c)%alb_nir_dir(i,1) =  x2a(index_x2a_Sx_alb_nir_a_dir, ig)
          cam_in(c)%alb_nir_dir(i,2) =  x2a(index_x2a_Sx_alb_nir_b_dir, ig)
          cam_in(c)%alb_nir_dir(i,3) =  x2a(index_x2a_Sx_alb_nir_c_dir, ig)
          cam_in(c)%alb_nir_dir(i,4) =  x2a(index_x2a_Sx_alb_nir_d_dir, ig)
          cam_in(c)%alb_nir_dir(i,5) =  x2a(index_x2a_Sx_alb_nir_e_dir, ig)
          cam_in(c)%alb_nir_dir(i,6) =  x2a(index_x2a_Sx_alb_nir_f_dir, ig)
          cam_in(c)%alb_nir_dir(i,7) =  x2a(index_x2a_Sx_alb_nir_g_dir, ig)
          cam_in(c)%alb_nir_dif(i,1) =  x2a(index_x2a_Sx_alb_nir_a_dif, ig)
          cam_in(c)%alb_nir_dif(i,2) =  x2a(index_x2a_Sx_alb_nir_b_dif, ig)
          cam_in(c)%alb_nir_dif(i,3) =  x2a(index_x2a_Sx_alb_nir_c_dif, ig)
          cam_in(c)%alb_nir_dif(i,4) =  x2a(index_x2a_Sx_alb_nir_d_dif, ig)
          ...
          cam_in(c)%snowfrac(i)  =  x2a(index_x2a_Sl_snowfrac, ig)
  ...
  subroutine atm_export( cam_out, a2x )
    ...
    do c=begchunk, endchunk
	  ...
	  a2x(index_a2x_Sa_dens   ,ig) = cam_out(c)%rho(i)
          ...
          a2x(index_a2x_Faxa_nir_a_dir,ig) = cam_out(c)%flx_nir_dir(i,1)
          a2x(index_a2x_Faxa_nir_b_dir,ig) = cam_out(c)%flx_nir_dir(i,2)
          a2x(index_a2x_Faxa_nir_c_dir,ig) = cam_out(c)%flx_nir_dir(i,3)
          a2x(index_a2x_Faxa_nir_d_dir,ig) = cam_out(c)%flx_nir_dir(i,4)
          a2x(index_a2x_Faxa_nir_e_dir,ig) = cam_out(c)%flx_nir_dir(i,5)
          a2x(index_a2x_Faxa_nir_f_dir,ig) = cam_out(c)%flx_nir_dir(i,6)
          a2x(index_a2x_Faxa_nir_g_dir,ig) = cam_out(c)%flx_nir_dir(i,7)
          a2x(index_a2x_Faxa_nir_a_dif,ig) = cam_out(c)%flx_nir_dif(i,1)
          a2x(index_a2x_Faxa_nir_b_dif,ig) = cam_out(c)%flx_nir_dif(i,2)
          a2x(index_a2x_Faxa_nir_c_dif,ig) = cam_out(c)%flx_nir_dif(i,3)
          a2x(index_a2x_Faxa_nir_d_dif,ig) = cam_out(c)%flx_nir_dif(i,4)
          a2x(index_a2x_Faxa_nir_e_dif,ig) = cam_out(c)%flx_nir_dif(i,5)
          a2x(index_a2x_Faxa_nir_f_dif,ig) = cam_out(c)%flx_nir_dif(i,6)
          a2x(index_a2x_Faxa_nir_g_dif,ig) = cam_out(c)%flx_nir_dif(i,7)
