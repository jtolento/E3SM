...
readonly CASE_NAME="f_pre_ind_sym_splt"
...
readonly RUN_REFDIR="/pscratch/sd/j/jtolento/E3SM/f_pre_asm_daily_cont/run"
readonly RUN_REFCASE="f_pre_ind_asm_daily_cont"
readonly RUN_REFDATE="1854-04-20"   # same as MODEL_START_DATE for 'branch', can be different for 'hybrid'
...
case_setup() {
    ...
    export NPROCS_ATM=128
    export NPROCS_LND=128
    export NPROCS_ROF=128
    export NPROCS_ICE=128
    export NPROCS_OCN=128
    export NPROCS_WAV=4
    export NPROCS_CPL=128
    export NPROCS_GLC=4
    export NPROCS_ESP=4
    export NPROCS_IAC=4
