...
readonly CASE_NAME="WCYCL1850_asym_splt"
...
# Set paths
readonly CODE_ROOT="/global/homes/j/jtolento/E3SM_asm_splt/"
...
#readonly run='L_1x3_nmonths'  # build with this to ensure non-threading
...
cat << EOF >> user_nl_eam
 ...
 fincl6 = 'ASDIR','ALDIR','ASDIF','ALDIF','SD_SPLT_BND','SU_SPLT_BND','FLNS','FLDS','FSNS','FSNT','FSNTOA','FSUTOA','FSDS','SOLIN','SOLL','SOLLD','SOLS','SOLSD'
...
#    export NPROCS_LND=400
#    export NPROCS_ROF=400
#    export NPROCS_ICE=600
#    export NPROCS_OCN=400
#    export NPROCS_CPL=900
#    export NPROCS_WAV=1
#    export NPROCS_GLC=1
#    export NPROCS_ESP=1
#    export NPROCS_IAC=1
