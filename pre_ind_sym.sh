...
readonly CASE_NAME="pre_ind_mpassi"
...
cat << EOF >> user_nl_eam
 nhtfrq =   0,0,-6,-6,-3,-24,0,0,0,0
 mfilt  = 1,12,120,120,240,30,1,12,12,12
 avgflag_pertape = 'A','A','I','A','A','A','I','A','A','A'
 ...
 fincl8 = 'FLNS','FLDS','FSNS','FSNT','FSNTOA','FSUTOA','FSDS','SOLIN','SOLL','SOLLD','SOLS','SOLSD','SW_ALBEDO_DIF','SW_ALBEDO_DIR','SW_UP_BOA_BND','SW_DN_BOA_BND','SW_DN_TOA_BND','SW_UP_TOA_BND','FUS','FDS'


 fincl9 = 'TS','T925','T850','QRS','TAP','UAP','VAP','QAP','T8501000','T9251000','TREFHT','TREFHTMN:M','TREFHTMX:X'


 fincl10= 'OMEGA1000','OMEGA975','OMEGA950','OMEGA925','OMEGA900','OMEGA850','U1000','U975','U950','U925','U900','U850','V1000','V975','V950','V925','V900','V850'
